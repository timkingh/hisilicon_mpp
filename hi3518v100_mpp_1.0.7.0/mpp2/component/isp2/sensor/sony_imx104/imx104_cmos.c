...
#define CMOS_IMX104_ISP_WRITE_SENSOR_ENABLE (0)
/****************************************************************************
 * local variables                                                            *
 ****************************************************************************/
...
static HI_S32 cmos_get_ae_default(AE_SENSOR_DEFAULT_S *pstAeSnsDft)
{
    ...
    switch(gu8SensorMode)
    {
        ...
        case 1: //WDR mode
            ...
            pstAeSnsDft->u32MaxAgain = 0;  /* 4.5db fixed */
            pstAeSnsDft->u32MinAgain = 0;
            pstAeSnsDft->u32MaxAgainTarget = 0;
            pstAeSnsDft->u32MinAgainTarget = 0;
            
            pstAeSnsDft->u32MaxDgain = 40;  /* 12db / 0.3db = 80 */
            pstAeSnsDft->u32MinDgain = 0;
            pstAeSnsDft->u32MaxDgainTarget = 0;
            pstAeSnsDft->u32MinDgainTarget = 0;
...
{
    HI_U16 u16Vmax = (gu32FullLinesStd * u8SlowFrameRate) >> 4;
    HI_U16 u16Current;
