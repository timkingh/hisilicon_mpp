...
HI_U32 cmos_get_isp_default(ISP_CMOS_DEFAULT_S *pstDef)
{
    ...
    switch (gu8SensorMode)
    {
        ...
        break;
        case 1:
            pstDef->stComm.u8Rggb           = 0x1;      //2: gbrg  
...
static HI_S32 cmos_get_ae_default(AE_SENSOR_DEFAULT_S *pstAeSnsDft)
{
    ...
    switch(gu8SensorMode)
    {
        ...
        case 1: //WDR mode
            ...
            pstAeSnsDft->u32MaxIntTime = 672;
            pstAeSnsDft->u32MinIntTime = 128;
            pstAeSnsDft->u32MaxIntTimeTarget = 672;  /* for short exposure, Exposure ratio = 16X */
            pstAeSnsDft->u32MinIntTimeTarget = 128;

            pstAeSnsDft->u32MaxAgain = 3;  /* 18db / 6db = 3 */
            pstAeSnsDft->u32MinAgain = 0;
            pstAeSnsDft->u32MaxAgainTarget = 0;
            pstAeSnsDft->u32MinAgainTarget = 0;
