...
static AWB_CCM_S g_stAwbCcm =
{
     ...
     5000,
       {
          0x01BF, 0x8081, 0x803E,
          0x8044, 0x016F, 0x802B,
          0x800C, 0x8090, 0x019C
       },
       
       3200,
       {
          0x01e1,0x80b8,0x8029,
          0x805a,0x0170,0x8016,
          0x800e,0x80f3,0x0201
       },
       
       2600,
       {
     
        0x0219, 0x80f2, 0x8027,
        0x8037, 0x0156, 0x801f,
        0x000a, 0x819D, 0x0292
       }
...
static HI_S32 cmos_get_ae_default(AE_SENSOR_DEFAULT_S *pstAeSnsDft)
{
    ...
    pstAeSnsDft->u32MaxDgain = 719;  /* 8 / 0.03125 = 256; 22.5 / 0.03125 = 720 */
    pstAeSnsDft->u32MinDgain = 32;
    pstAeSnsDft->u32MaxDgainTarget = 720;
    ...
    AE_SENSOR_DEFAULT_S *pstAeSnsDft)
{
    ...
    sensor_write_register(0x300A, u16FullLine);
...
static HI_VOID cmos_gains_update(HI_U32 u32Again, HI_U32 u32Dgain)
{
    ...
    {
        g_stSnsRegsInfo.astI2cData[2].u32Data = (u32Dgain << 4) / 45;
