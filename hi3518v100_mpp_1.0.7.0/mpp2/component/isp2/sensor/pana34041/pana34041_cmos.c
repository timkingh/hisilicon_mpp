...
static HI_S32 cmos_get_ae_default(AE_SENSOR_DEFAULT_S *pstAeSnsDft)
{
    ...
    pstAeSnsDft->u32MaxDgain = 120;  /* 12db / 0.1 = 120 */
    pstAeSnsDft->u32MinDgain = 0;
    pstAeSnsDft->u32MaxDgainTarget = 120;
...
#if 0
static HI_U8 gau8DgainFine[0x81] =
{
...
#endif
static HI_U32 gau32DgainTbl[0x81]=
{ 
...
static HI_VOID cmos_gains_update(HI_U32 u32Again, HI_U32 u32Dgain)
{
    ...
    u32Dgain = 0x80 + i;
    #endif
    u32Dgain = 0x80 + cmos_db_tbl(u32Dgain);
