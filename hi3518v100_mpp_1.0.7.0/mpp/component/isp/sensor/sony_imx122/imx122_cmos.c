		...
		HI_U32 exposure_shift)
{
    ...
    times = ((HI_U64)exposure0 * 1024)/exposure_max;
    ...
    else
    {
        ...
        if (times > analog_gain_table[80])
        {
            times = analog_gain_table[80];
        }
        
        exposure0 = (HI_U64)exposure0*1024/times;
		...
		HI_U32 exposure_shift)
{
    ...
    else
    {
        ...
        if (times > digital_gain_table[60])
        {
            times = digital_gain_table[60];
        }
