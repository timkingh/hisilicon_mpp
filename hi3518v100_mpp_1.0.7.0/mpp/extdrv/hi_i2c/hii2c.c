...
unsigned long  g_u32LockFlags;
#define I2C_SPIN_LOCK     spin_lock_irqsave(&g_stI2CLock, g_u32LockFlags)
#define I2C_SPIN_UNLOCK   spin_unlock_irqrestore(&g_stI2CLock, g_u32LockFlags)
