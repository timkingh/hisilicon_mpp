    ...
    AE_SENSOR_DEFAULT_S *pstAeSnsDft)
{
    ...
    if(u16FullLine != last_vblanking_lines)
    {
        sensor_write_register(0x03, 0x0);
        sensor_write_register(0x08, u16FullLine>>8);
        sensor_write_register(0x09, u16FullLine&0xFF);
        sensor_write_register(0x0A, u16FullLine>>8);
        sensor_write_register(0x0B, u16FullLine&0xFF);
        sensor_write_register(0x03, 0x1);
        last_vblanking_lines = u16FullLine;
    }  
    return;
}
