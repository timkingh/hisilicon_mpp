...
himm 0x20110154  0x03ff6         #TOE/ETH
...
himm 0x20120168  0x03ff5         #A9/(Hi3532 RMI) 
himm 0x2012016c  0x03ff6         #ARMD JPGD JPGE
himm 0x20120170  0x03ff6         #MD 
himm 0x20120174  0x03ff6         #VOIE
himm 0x20120178  0x03ff3         #VDH0 VDH1 BPD
himm 0x2012017c  0x10c02         #VENC0 VENC1
himm 0x20120180  0x03ff4         #VCMP TDE0 TDE1
himm 0x20120184  0x03ff2         #VPSS0 VPSS1
himm 0x20120188  0x10601         #VICAP
himm 0x2012018c  0x10100         #VDP

#mddrc order control idmap_mode
himm 0x20120100 0x67      #mddrc order enable mddrc idmap mode select
himm 0x20120020 0x10785     #双ddr操作挂死问题规避
