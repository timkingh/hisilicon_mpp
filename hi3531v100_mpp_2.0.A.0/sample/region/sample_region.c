...
void SAMPLE_RGN_Usage(HI_CHAR *sPrgNm)
{
    ...
    printf("\t 0) D1 Vi cover region + D1 Venc + HD output\n");
    printf("\t 1) Overlay region + D1 Venc + HD output\n");
