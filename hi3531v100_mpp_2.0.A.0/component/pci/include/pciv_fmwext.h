...
typedef HI_S32 FN_PCIV_PicFreeFromVo(PCIV_CHN pcivChn, PCIV_VOPIC_S *pVoPic);
...
typedef struct hiPCIVFMW_CALLBACK_S
{
    ...
    FN_PCIV_PicFreeFromVo        *pfPicFreeFromVo;
...
HI_S32 PCIV_FirmWarePicVoShow(PCIV_CHN pcivChn, PCIV_VOPIC_S *pVoPic, VOU_WHO_SENDPIC_E enWhoSend);
