...
typedef struct hiBIND_RECEIVER_INFO_S
{
    ...
    HI_U32      u32MaxDevCnt;   /* If no dev id, should set it 1 */
    HI_U32      u32MaxChnCnt;
    HI_S32      (*pCallBack)(HI_S32 s32DevId, HI_S32 s32ChnId, 
...
#define SYS_GETVREGADDR        _IOWR(IOC_TYPE_SYS, IOC_NR_SYS_GETVREGADDR, HI_U32)
...
HI_S32 SYS_BIND_SendData(MOD_ID_E enModId, HI_S32 s32DevId, HI_S32 s32ChnId, 
        MPP_DATA_TYPE_E enDataType, HI_VOID *pvData);
