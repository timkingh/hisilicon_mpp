...
typedef enum hiSYS_FUNC_E
{
    ...
    SYS_SIO_SAMPLECLK_DIVSEL,
    SYS_SIO_BITCKL_DIVSEL,
    SYS_SIO_SYSCKL_SEL,
    SYS_SIO_SYSCKL_GET_SEL,
    SYS_SIO_MASTER,         
    SYS_SIO_PINMUX_SEND,    
    SYS_SIO_ACKOUT_SEL,     
    SYS_SIO_PCMMODE_SEL,    
    ...
    SYS_SIO_RESET_SEL,          /* SIO软复位 */
    SYS_SIO_CLK_EN,             /* SIO时钟门控 */
...
typedef struct hiSYS_EXPORT_FUNC_S
{
    ...
    HI_S32  (*pfnSysSendData)      (MOD_ID_E enModId, HI_S32 s32DevId, 
        HI_S32 s32ChnId, MPP_DATA_TYPE_E enDataType, HI_VOID *pvData);
    ...
    HI_S32 (*pfnAddOneSpinRec)(HI_U32 *u32SpinRecAddr, HI_U8 *pu8ModeName, HI_U8 *pu8LockName);
...
#define CALL_SYS_SendData(enModId, s32DevId, s32ChnId, enDataType, pvData) \
    FUNC_ENTRY(SYS_EXPORT_FUNC_S, HI_ID_SYS)->pfnSysSendData(enModId, s32DevId, s32ChnId, enDataType, pvData)
